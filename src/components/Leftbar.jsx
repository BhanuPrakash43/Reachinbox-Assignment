...
function Leftbar({ onMenuItemClick }) {
  ...
  return (
    <div className="dark:bg-[#101113] bg-white no-scrollbar h-screen w-20 flex flex-col justify-between items-center py-6 border-r-2 dark:border-[#343A40] border-[#E0E0E0] left-0 top-0 fixed z-10">
      ...
      <div className="text-white bg-green-500 p-2 rounded-full">BP</div>
    </div>
  );
}
